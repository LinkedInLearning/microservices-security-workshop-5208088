...
INITIAL_PLANETS = [
    {"id": 1, "name": "Earth", "size": 12742, "population": 8000000000},
    {"id": 2, "name": "Mars", "size": 6779, "population": 0},
    {"id": 3, "name": "Jupiter", "size": 139820, "population": 0},
    {"id": 4, "name": "Saturn", "size": 116460, "population": 0},
    {"id": 5, "name": "Venus", "size": 12104, "population": 0},
    {"id": 6, "name": "Mercury", "size": 4879, "population": 0},
    {"id": 7, "name": "Uranus", "size": 50724, "population": 0},
    {"id": 8, "name": "Neptune", "size": 49244, "population": 0},
    {"id": 9, "name": "Pluto", "size": 2376, "population": 0},
    {"id": 10, "name": "Tatooine", "size": 10465, "population": 200000},
    {"id": 11, "name": "Coruscant", "size": 12742, "population": 1000000000000},
    {"id": 12, "name": "Arrakis", "size": 12000, "population": 10000000},
    {"id": 13, "name": "Vulcan", "size": 15000, "population": 6000000000},
    {"id": 14, "name": "Krypton", "size": 18000, "population": 0},
    {"id": 15, "name": "Pandora", "size": 11447, "population": 0},
    {"id": 16, "name": "Gallifrey", "size": 25000, "population": 2000000000},
    {"id": 17, "name": "Ego", "size": 30000, "population": 1},
    {"id": 18, "name": "Xandar", "size": 14000, "population": 1000000000},
    {"id": 19, "name": "Knowhere", "size": 5000, "population": 1000000},
    {"id": 20, "name": "Sakaar", "size": 20000, "population": 500000000},
    {"id": 21, "name": "Asgard", "size": 22000, "population": 10000000},
    {"id": 22, "name": "Naboo", "size": 12120, "population": 4500000000},
    {"id": 23, "name": "Endor", "size": 4900, "population": 30000000},
    {"id": 24, "name": "Hoth", "size": 7200, "population": 0},
    {"id": 25, "name": "Dagobah", "size": 8900, "population": 0}
]
...
async def delete_planet(planet_id: int):
    ...
    for i, planet in enumerate(planets):
        if planet["id"] == planet_id:
            planets.pop(i)
            return {"message": f"Planet {planet_id} destroyed successfully"}
    raise HTTPException(status_code=404, detail="Planet not found")
